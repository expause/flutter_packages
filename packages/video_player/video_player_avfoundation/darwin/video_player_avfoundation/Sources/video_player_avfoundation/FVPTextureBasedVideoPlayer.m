...
#import "./include/video_player_avfoundation/FVPDecryptionLoaderDelegate.h"
...
@property (nonatomic, strong) FVPDecryptionLoaderDelegate *decryptionDelegate;
@end
...
- (instancetype)initWithURL:(NSURL *)url
    ...
    [urlAsset.resourceLoader setDelegate:self.decryptionDelegate queue:dispatch_get_main_queue()];
